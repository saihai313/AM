...
<div class="container theme-showcase mainSTable">
  <h1>근무 스케쥴</h1>
...
<script type="text/tmpl" id="tmpl">
  ...
  <table class="calendar-table table table-condensed table-tight calTable">
    <thead>
      <tr>
            ...
            <tr>
              ...
              <td>
                <span class="btn-group btn-group-lg">
                  {{ if (mode !== 'day') { }}
                    {{ if (mode === 'month') { }}<span class="js-cal-option btn" data-mode="year">{{: months[month] }}</span>{{ } }}
                    {{ if (mode ==='week') { }}
...
<div class="mainBtn">
<hr>
<button class="btn-primary sBtn">파트 타임 등록</button>
<button class="btn-primary sBtn" id="pixS">고정 스케쥴 등록</button>
...
var data = [],
    ...
    h, 
    m,
    names = ['All Day Event', 'Long Event', 'Birthday Party', 'Repeating Event', '띠용', 'Meeting', 'Mr. Behnke', 'Date', 'Ms. Tubbs'],
