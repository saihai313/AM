...
<head>
 ...
 <c:set var="contextPath" value="${pageContext.servletContext.contextPath}" scope="application"/>
  ...
  <!-- CSS Files -->
  <link href="${contextPath}/resources/assets/css/black-dashboard.css?v=1.0.0" rel="stylesheet" />
...
<!-- Navbar -->
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="${contextPath}/resources/assets/img/anime3.png" alt="Profile Photo">
                  </div>
    ...
    <div class="dropdown show-dropdown">
      ...
      <!--   Core JS Files   -->
  <%-- <script src="${contextPath}/resources/assets/js/core/jquery.min.js"></script> --%>
  ...
  <script src="${contextPath}/resources/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
  ...
  <script src="${contextPath}/resources/assets/js/black-dashboard.min.js?v=1.0.0"></script><!-- Black Dashboard DEMO methods, don't include it in your project! -->
  <script src="${contextPath}/resources/assets/demo/demo.js"></script>
