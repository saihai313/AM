				...
				<div class="row">
					<div class="col-md-12">
						<div class="card ">
							...
							<form action="${contextPath }/board/insertNews"
									...
									<tbody>
										<tr style="line-height: 32px;">
											...
											<td><input type="text" name="title" class="form-control"
												value="" required></td>
											<td>뉴스 타입</td>
											<td><select id="newsselect" name="newsType">
													<option selected>--선택--</option>
													<option value='1'>관련 뉴스</option>
													<option value='2'>생활 뉴스</option>
											</select></td>
										...
										<tr>
											...
											<td>회원 구분</td>
											<td><select id="memberselect" name="memberType">
													<option selected>--선택--</option>
						...
						<div class="card">
							<div class="card-header">
								<i class="fas fa-square"></i> 뉴스 정보 조회
							</div>
							<div class="card-body">
								<table class="table">
									<tbody>
