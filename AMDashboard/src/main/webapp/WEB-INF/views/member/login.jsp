...
<div class="login">
  <h1>Login</h1>
    <form action="member/loginAction" method="post" >
      <input type="text" id="memberEmail" name="memberEmail" placeholder="UserEmail" required="required" />
        <input type="password" id="memberPwd" name="memberPwd" placeholder="Password" required="required" />
